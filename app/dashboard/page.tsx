      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted small m-0">
            Visualización general del personal y estado contractual acumulado.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <Card className="shadow-sm border-0 bg-white p-5 text-center my-3 animate__animated animate__fadeIn">
          <div className="card-body mx-auto" style={{ maxWidth: '550px' }}>
            <div
              className="bg-light text-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-4 shadow-sm"
            ...
            <p className="text-secondary small mb-4">
              La base de datos de control contractual se encuentra vacía en este momento. Para
              comenzar a auditar alertas de continuidad y horas compensatorias, selecciona una de
              las siguientes opciones de alimentación:
            </p>
            ...
            <Row className="g-3">
                ...
                <div className="p-3 border rounded bg-light h-100 d-flex flex-column justify-content-between">
                  <div>
                    <h6 className="fw-bold text-dark mb-1 small">
                      <i className="bi bi-cloud-arrow-up-fill text-success me-1"></i> Carga Masiva
                    </h6>
                    <p className="text-muted" style={{ fontSize: '0.75rem' }}>
                      Importa los reportes unificados de planillas exportadas desde SIGPER.
                    </p>
                  </div>
                  <Button
                    as={Link as any}
              ...
              <Col sm={6}>
                <div className="p-3 border rounded bg-light h-100 d-flex flex-column justify-content-between">
                  <div>
                    <h6 className="fw-bold text-dark mb-1 small">
                      <i className="bi bi-person-plus-fill text-primary me-1"></i> Registro Manual
                    </h6>
                    <p className="text-muted" style={{ fontSize: '0.75rem' }}>
                      Inscribe de forma individual la ficha de identidad y anexo de un nuevo
                      funcionario.
                    </p>
                  </div>
                  <Button
            ...
            <div className="table-responsive">
              <Table hover className="align-middle mb-0">
                <thead className="table-dark">
                  <tr>
                    <th className="ps-4 py-3" style={{ backgroundColor: '#212529' }}>
                      RUT
                    </th>
                    <th className="py-3" style={{ backgroundColor: '#212529' }}>
                      Nombre Completo
                    </th>
                    <th className="text-center py-3" style={{ backgroundColor: '#212529' }}>
                      N° Contratos
                    </th>
                    <th className="text-end pe-4 py-3" style={{ backgroundColor: '#212529' }}>
                      Acciones
                    </th>
                  </tr>
                </thead>
                    ...
                    return (
                      <tr key={t.rut}>
                        ...
                        <td className="text-center">
                          <Badge
                            bg={totalContratos > 1 ? 'info' : 'light'}
                            text="dark"
                            className={totalContratos > 1 ? '' : 'border'}
                          >
