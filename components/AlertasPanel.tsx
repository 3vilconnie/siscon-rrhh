...
import { Row, Col, Card, Badge, Alert, Spinner, Button, CloseButton, ListGroup } from 'react-bootstrap';
      ...
      <Col xs={12} lg={6}>
        <Card className="shadow-sm border-0 bg-white">
          <Card.Header className="bg-danger text-white fw-bold d-flex align-items-center justify-content-between py-3">
            ...
            <Badge pill bg="white" className="text-danger fw-bold small">Próxima Renovación</Badge>
          </Card.Header>
              ...
              alertas.map((a) => (
                ...
                >
                  <div className="d-flex justify-content-between align-items-start">
                    ...
                    <Badge bg="danger" className="p-2 small">{a.totalContratos} Contratos</Badge>
                  </div>
                  ...
                  <div className="mt-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                    ...
                    <Button variant="link" size="sm" className="text-danger p-0 fw-bold text-decoration-none small">
                    ...
                    <React.Fragment key={c.id}>
                      ...
                      {brecha && (
                        <div className="position-relative my-3 ps-4">
                          ...
                          <Badge bg={brecha.meses < parametros.enfriamiento_meses ? 'danger' : 'success'} className="text-white border small">
                      ...
                      <div className="position-relative mb-4 ps-4">
                        ...
                        <Card className={`border-0 shadow-sm ${esVigente ? 'border-start border-3 border-success' : 'border-start border-3 border-secondary'}`}>
                          <Card.Body className="p-3">
                            <div className="d-flex justify-content-between align-items-center mb-1">
                              <span className="fw-bold text-dark small">Contrato #{idx + 1}</span>
                              <Badge bg={esVigente ? 'success' : 'secondary'} style={{ fontSize: '0.65rem' }}>
